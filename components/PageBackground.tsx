...
export type BgVariant = "trainer" | "recipes" | "tracking" | "profile" | "macro";
    ...
    >
      <Defs>
        ...
        <RadialGradient id="vio_b" cx="50%" cy="50%" r="50%">
          <Stop offset="0%"   stopColor="#1e1b8e" stopOpacity="0.65" />
          <Stop offset="100%" stopColor="#1e1b8e" stopOpacity="0"    />
        </RadialGradient>
        <RadialGradient id="vio_c" cx="50%" cy="50%" r="50%">
          <Stop offset="0%"   stopColor="#f43f5e" stopOpacity="0.48" />
