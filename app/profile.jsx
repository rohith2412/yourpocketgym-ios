...
const es = StyleSheet.create({
  ...
  head: {
    ...
    padding: 16, borderBottomWidth: 1, borderBottomColor: "#e8e5de",
  },
  ...
  chip: {
    ...
    borderWidth: 1.5, borderColor: "#e8e5de", backgroundColor: "#fafaf8",
  },
          ...
          <View style={s.heroInfo}>
            ...
            <View style={s.pillsRow}>
              ...
              {profile?.workoutDaysPerWeek > 0 && (
                <View style={s.pill}>
                  <Text style={s.pillText}>{profile.workoutDaysPerWeek}×/wk</Text>
                </View>
              )}
            </View>
          </View>
                ...
                <View style={s.bmiBar}>
                  {[
                    ...
                    <View
                      ...
                      style={{
                        flex: seg.w, height: 6,
                        backgroundColor: seg.color, opacity: 0.6, borderRadius: 99,
                      }}
                    />
                  ))}
                </View>
          ...
          {profile?.isSubscribed && (
            <>
              ...
              <MenuRow
                ...
                label={
                  canceling     ? "Canceling…"           :
                  cancelConfirm ? "Tap again to confirm" :
                                  "Cancel subscription"
                }
...
const s = StyleSheet.create({
  ...
  pill: {
    ...
    backgroundColor: "#f4f2ed", borderWidth: 1, borderColor: "#e8e5de",
  },
